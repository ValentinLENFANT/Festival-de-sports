...
<form method='post' action='creationEtablissement.php?' onsubmit='return vFormulaire(this)'>
...
<tr class='enTeteTabNonQuad'>
      ...
      <tr class="ligneTabNonQuad">
         ...
         size="4" maxlength="5" onblur="vcodePostal(this)"></td>
      </tr>
      <tr class="ligneTabNonQuad">
         <td> Ville*: </td>
      ...
      <tr class="ligneTabNonQuad">
         ...
         maxlength="10" onblur="vtel(this)"></td>
      </tr>
      <tr class="ligneTabNonQuad">
         <td> E-mail: </td>
      ...
      <tr class="ligneTabNonQuad">
         ...
         <tr class='ligneTabNonQuad'>
          ...
          <tr class="ligneTabNonQuad">
            ...
            "nombreChambresOffertes" size ="2" maxlength="3" onblur="vnombreChambresOffertes(this)"></td>
         </tr>
		 <tr class="ligneTabNonQuad">
         ...
         <td> <INPUT type="checkbox" name="ConventionSignee" value="1"class="checkbox_type_value"> Cliquez pour signer la convention
...
<br>
      ...
      <tr>
         <td align='center'><input type='submit' class='btn2 btn-inverse2' value='Valider' name='valider'>
